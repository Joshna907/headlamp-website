...
description: "Inspect Argo CD Applications and GitOps workloads in Headlamp."
authors: ["joshna-waikar"]
tags: ["kubernetes", "headlamp", "plugins", "argocd", "gitops"]
...
[A walkthrough of the Argo CD plugin for Headlamp](https://youtu.be/K13S100YPM0)
...
![Headlamp showing a list of Argo CD Applications with project, source, destination, sync, and health information](./application-list.png)

*Argo CD Application inventory in Headlamp*
...
![Argo CD Application detail page in Headlamp showing GitOps summary, source, and destination](./application-detail.png)

*Application source, destination, sync, and health context*
...
![Managed Resources section showing a Service and Deployment with sync, health, namespace, and API information](./managed-resources.png)

*Resources reported as managed by an Argo CD Application*
...
![Headlamp Map showing an Argo CD Application connected to a Deployment and Service](./resource-tree.png)

*An Application and its managed Kubernetes resources in Headlamp's Map*
...
![Headlamp Map showing a remote Argo CD managed resource as a read-only node](./remote-resource.png)

*Remote or unverified managed resources remain visible without unsafe local links*
...
![Headlamp rollback dialog listing earlier Argo CD deployment history entries with revisions and deployment times](./rollback.png)

*Rollback requires an explicit historical deployment selection*
...
![The guestbook Application opened in the native Argo CD web interface](./open-in-argocd.png)

*Headlamp can open the same Application in the configured Argo CD UI*
